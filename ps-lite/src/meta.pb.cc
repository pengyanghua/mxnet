...
const int PBMeta::kResponseTimeFieldNumber;
const int PBMeta::kStartTimeFieldNumber;
const int PBMeta::kEndTimeFieldNumber;
const int PBMeta::kReceiveTimeFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 9: {
        ...
        if (input->ExpectTag(80)) goto parse_response_time;
        break;
      }
      ...
      case 12: {
        ...
        if (input->ExpectTag(104)) goto parse_receive_time;
        break;
      }
...
void PBMeta::SerializeWithCachedSizes(
  ...
  if (has_response_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(10, this->response_time(), output);
  }

  // optional int64 start_time = 11;
  if (has_start_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(11, this->start_time(), output);
  }

  // optional int64 end_time = 12;
  if (has_end_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(12, this->end_time(), output);
  }

  // optional int64 receive_time = 13;
  if (has_receive_time()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(13, this->receive_time(), output);
  }
