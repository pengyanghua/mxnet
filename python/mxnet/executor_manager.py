...
class DataParallelExecutorGroup(object):
	...
	print("Entering __ini__ of DataParallelExecutorGroup")
    ...
    def backward(self):
        ...
        for texec in self.train_execs:
	    #print("The debug string for this executor is:")
...
class DataParallelExecutorManager(object):
	...
	#print("****************************************************")
	#print("In DataParallelExecutorManager backward")
	#print(self.curr_execgrp.debug_str())
