...
class MXNET_API Engine {
 public:
  ...
  virtual void SetNodeID(int id=0){ node_id = id;}
  virtual int GetNodeID() {return node_id;}
  /*!
   ...
   */
  virtual void Push(OprHandle op, Context exec_ctx, int priority = 0, bool profiling = false,bool record = false,int node_id = 0) = 0;
  /*!
